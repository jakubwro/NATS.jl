...
function default_connect_options()
    (
        ...
        send_buffer_batch_interval = parse(Float64, get(ENV, "NATS_SEND_BUFFER_BATCH_INTERVAL_SECONDS", string(DEFAULT_SEND_BUFFER_BATCH_INTERVAL_SECONDS))),
...
function connect(
    ...
    nc = Connection(;
        ...
        options.send_buffer_batch_interval,
