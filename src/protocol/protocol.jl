...
@testitem "Serializing client operations." setup=[ProtocolTestUtils] begin
    using JSON3
    using NATS: Pub, Sub, Unsub
...
@testitem "Serializing headers." setup=[ProtocolTestUtils] begin
    using NATS: Msg, MIME_HEADERS
...
@testitem "Serializing typed handler results" setup=[ProtocolTestUtils] begin
    using NATS: Headers, MIME_HEADERS, MIME_PAYLOAD
...
@testitem "Nonce signatures" setup=[ProtocolTestUtils] begin
...
@testitem "Plain text messages" setup=[ProtocolTestUtils] begin
...
@testitem "Subject validation" setup=[ProtocolTestUtils] begin
